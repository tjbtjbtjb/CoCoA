...
CoCoA est prévu pour fonctionner aussi bien localement (installation locale de Python™ via `Spyder`, `Anaconda`) mais aussi sur des plateformes `Jupyter` comme `Google Colab` par exemple.

La documentation complète est disponible au travers [du Wiki](https://github.com/tjbtjbtjb/CoCoA/wiki/FR%3AHome), en particulier :
• Installation
• Utilisation de base
• Utilisation avancée
